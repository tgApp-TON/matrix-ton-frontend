...
function TonConnectProvider(t0) {
    ...
    if ($[0] !== "b996c0e71cc195eedae439105981cf2cd6e91d779ff808a798779f6f58e376e6") {
        for(let $i = 0; $i < 3; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "b996c0e71cc195eedae439105981cf2cd6e91d779ff808a798779f6f58e376e6";
    }
    const { children } = t0;
    const manifestUrl = ("TURBOPACK compile-time truthy", 1) ? `${window.location.origin}/tonconnect-manifest.json` : "TURBOPACK unreachable";
    console.log("[TonConnectProvider] Using manifest:", manifestUrl);
    let t1;
    if ($[1] !== children) {
...
//# sourceMappingURL=frontend_components_e458e3bf._.js.map
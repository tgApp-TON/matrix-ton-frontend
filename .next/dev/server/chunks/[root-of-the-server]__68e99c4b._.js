...
"[project]/frontend/app/api/user/register/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { telegramId, username, nickname, referralCode, country, // New fields
        firstName, lastName, languageCode, phoneNumber, isPremium } = body;
        // Find referrer
        let referrerId = 1; // Default to MASTER
        if (referralCode && referralCode !== 'MASTER') {
            const { data: referrer } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('User').select('id').eq('referralCode', referralCode).single();
            if (referrer) {
        ...
        const { data: user, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('User').insert({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__68e99c4b._.js.map
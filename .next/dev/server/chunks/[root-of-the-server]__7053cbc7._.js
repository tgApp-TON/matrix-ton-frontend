...
async function GET(request) {
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('User').select('id').eq('nickname', nickname).single();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7053cbc7._.js.map
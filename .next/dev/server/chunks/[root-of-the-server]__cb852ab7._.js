...
"[project]/frontend/app/api/admin/setup-master/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        // Find MASTER user
        const { data: masterUser, error: findError } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('User').select('id').eq('nickname', 'MASTER').single();
        ...
        const { error: updateError } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('User').update({
            role: 'FOUNDER'
        }).eq('id', masterId);
        if (updateError) {
        ...
        for(let tableNumber = 1; tableNumber <= 12; tableNumber++){
            const { data: table, error: tableError } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('Table').insert({
                userId: masterId,
                tableNumber,
                status: 'ACTIVE',
                cycleNumber: 1
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cb852ab7._.js.map
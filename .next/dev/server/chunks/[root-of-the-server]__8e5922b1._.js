...
"[project]/frontend/app/api/admin/check-master/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { data: masterUser, error: userError } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('User').select('id, nickname, role, telegramId').eq('nickname', 'MASTER').single();
        ...
        const { data: tables, error: tablesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('Table').select('id, tableNumber, status, cycleNumber').eq('userId', masterUser.id).order('tableNumber');
        return __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            user: masterUser,
            tables: tables || [],
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8e5922b1._.js.map